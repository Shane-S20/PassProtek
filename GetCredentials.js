...
window.onload = function() {
    ...
    document.getElementById("get").onclick = () => {
        ...
        if(document.getElementById("Entered_Credentials").value == "") {
            document.getElementById("RetrievedSuccess").innerHTML = '<br><div class="alert alert-danger"style="width: 280px;text-align: center; margin: auto"><strong>Please Enter The Credential To Continue</strong></div>'
        } 
        else{
                ...
                chrome.tabs.query({currentWindow: true, active: true}, function(tabs){
                    ...
                    if(atob(decryptURL) != tab)
                    {
                        ...
                        document.getElementById("continue").onclick = () => {
                            document.getElementById("Retrieved_Site").innerHTML = "Website Name: " + Requested_Website;
