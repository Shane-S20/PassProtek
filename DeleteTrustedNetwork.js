...
window.onload = function() {
    document.getElementById("DeleteNetworksButton").onclick = () => {
        ...
        if(document.getElementById("networkIP").value == "") {
            ...
            const Requested_Network = document.getElementById("networkIP").value;
            const searchVal = Data.get(sha256(Requested_Network))
            
            searchVal.onsuccess = () => {
                if(searchVal.result != undefined)
                {
                    const search = Data.delete(sha256(Requested_Network));
                    search.onsuccess = () => {
                    ...
                    search.onerror = () => {
                        document.getElementById("deleteNetworkSuccess").innerHTML = '<br><div class="alert alert-success"style="width: 280px;text-align: center; margin: auto"><strong> Failed to delete network </strong></div>'
