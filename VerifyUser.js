...
window.onload = function() {
    document.getElementById("loginButton").onclick = () => {
        ...
        const User = transaction.objectStore("Users");
    
        const user_search = User.get(entered_username);
        ...
        user_search.onsuccess = () => {
            ...
            if(document.getElementById("masterUname").value == "" || document.getElementById("masterPword").value == "") {
                ...
                // console.log(username_list)
                    for(i=0;i<10;i++){
                        ...
                        console.log("IN LOOP")
                        if(entered_username === keyRequest.result[i])
                        {
                    ...
                    if(toggle = false){
                        ...
                        document.getElementById("ErrorMessage").innerHTML = "INCORRECT CREDENTIALS, TRY AGAIN"
                    }
                    ...
                    if(toggle = true){
                        ...
                        if(encoded_input === stored_Input){
                            ...
                            //console.log("NOW TESTING PASSWORD")
                            window.location.href = "layout.html"  
                        }  
                        else{
                            document.getElementById("ErrorMessage").innerHTML = '<br><div class="alert alert-danger"style="width: 280px;text-align: center; margin: auto"><strong>Incorrect Credentials, Try Again!</strong></div>'
                        }
                    }
                }
            ...
            user_search.onerror = () => {
                console.log("THERE WAS AN ERROR VERIFYING USER")
            }
        }
    }
};
